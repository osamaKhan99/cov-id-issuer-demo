        ...
        <div className="outer-box clearfix">
              <div className="logo-box pull-left">
                  <figure className="logo">
                      <a rel="noopener noreferrer" href="https://hospitals.aku.edu/pakistan/Pages/default.aspx" target="_blank"><img src="assets/images/issuer-logos/logo-akuhk.png" alt="" /></a>
                  </figure><br />
                  <figure className="logo-covid19">
                      <a href="https://trust.net.pk/covid19"><img src="assets/images/logo.png" alt="" /></a>
                  </figure>
              </div>
                  ...
                  <nav className="main-menu navbar-expand-md navbar-light">
                      <div className="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                          <ul className="navigation scroll-nav clearfix">
                              ...
                              <li><a href="#symptoms">How it works</a></li>
                              <li><a href="#faq">FAQ</a></li>
                          </ul>
                      </div>
                  </nav>
                  <div className="btn-box">
                      <a href="login.html" className="theme-btn"><i className="fas fa-wallet"></i>Issue Immunity Creds</a>
                  </div>
              </div>
          </div>
